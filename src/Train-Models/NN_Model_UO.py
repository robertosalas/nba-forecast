...
mcp_save = ModelCheckpoint('/Users/robertosalas/Documents/code/NBA-Machine-Learning-Sports-Betting/Models/Trained-Model-OU-' + current_time, save_best_only=True, monitor='val_loss', mode='min')
